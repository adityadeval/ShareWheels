...
public class AdapterDisplayMyRidesFrag extends RecyclerView.Adapter<RecyclerView.ViewHolder>{
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holder, int position) {
        ...
        if (holder instanceof AdapterDisplayMyRidesFrag.PendingRidesViewHolder) {
            AdapterDisplayMyRidesFrag.PendingRidesViewHolder pendingRidesHolder = (AdapterDisplayMyRidesFrag.PendingRidesViewHolder) holder;
            /*
